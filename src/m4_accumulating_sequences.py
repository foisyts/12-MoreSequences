...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(99, 102)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    # Test 1:
    expected = '10443-'
    actual = make_simple_string(10443, 10443)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 1:
    expected = '10443'
    actual = make_less_simple_string(10443, 10443)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        bottom_right = rg.Point(center.x + radius, center.y + radius)
        sequence_rectangles = sequence_rectangles + [rg.Rectangle(top_left, bottom_right)]
    return sequence_rectangles
